    ...
    <div class="header-bottom">
        <div class="container">
            <div class="header-area">
                <div class="logo">
                    <a href="{{asset('/')}}"><img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}"
                                                alt="logo"></a>
                </div>
                <ul class="menu">
...
<footer>
    <div class="footer-top">
        <div class="container">
            <div class="logo">
                <a href="{{asset('/')}}"><img src="{{getImage(imagePath()['logoIcon']['path'] .'/logo.png')}}" alt="logo"></a>
            </div>
...
<script>
    $(document).on("change", ".langSel", function () {
        window.location.href = "{{asset('/')}}/change/" + $(this).val();
    });
</script>
@stack('script')
