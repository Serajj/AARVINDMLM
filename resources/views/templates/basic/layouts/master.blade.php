...
<head>
    ...
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/all.min.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/animate.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/nice-select.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/swiper.min.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/magnific-popup.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/odometer.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/flaticon.css')}}">

    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/line-awesome.min.css')}}">

    @stack('style-lib')
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/main.css')}}">
    <link rel="stylesheet" href="{{url($activeTemplateTrue . 'frontend/css/custom.css')}}">
    @stack('css')
    <link rel="stylesheet" href='{{ url($activeTemplateTrue."frontend/css/color.php?color=$general->base_color")}}'>
...
<script src="{{url($activeTemplateTrue . 'frontend/js/modernizr-3.6.0.min.js')}}"></script>
<script src="{{url($activeTemplateTrue . 'frontend/js/plugins.js')}}"></script>
<script src="{{url($activeTemplateTrue . 'frontend/js/bootstrap.min.js')}}"></script>
<script src="{{url($activeTemplateTrue . 'frontend/js/isotope.pkgd.min.js')}}"></script>
<script src="{{url($activeTemplateTrue . 'frontend/js/magnific-popup.min.js')}}"></script>
...
<script src="{{url($activeTemplateTrue . 'frontend/js/nice-select.js')}}"></script>
@stack('script-lib')
